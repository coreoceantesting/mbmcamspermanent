...
class ReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.reports.month-wise-report')->with(['dateRanges'=> $dateRanges,
    ...
    public function musterReport(Request $request)
    {
        ...
        return view('admin.reports.muster-report')->with([ 'errorMessage'=> $errorMessage,
                                                        'empList'=> $empList,
                                                        'weekDays'=> $weekDays,
                                                        'holidays'=> $holidays,
                                                        'settings'=> $settings,
    ...
    public function todaysPresentReport(Request $request)
    {
        ...
        $data = Punch::withWhereHas(
                        'user', fn($qr)=> $qr->select('id', 'device_id', 'ward_id', 'department_id', 'emp_code', 'name', 'contractor_id','designation_id')
