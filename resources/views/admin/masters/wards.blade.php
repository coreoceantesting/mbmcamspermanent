                        ...
                        <form class="form-horizontal form-bordered" method="post" id="editForm">
                            ...
                            <section class="card">
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-md-4">
                                            <label class="col-form-label" for="edit_name">Ward Name <span class="text-danger">*</span></label>
                                            <input class="form-control" id="edit_name" name="edit_name" type="text" placeholder="Ward Name">
                            ...
                            <div class="table-responsive">
                                <table class="table-bordered" id="datatable-tabletools">
                                    <thead>
                                        <tr>
                                            <th>Sr No</th>
                                            <th style="max-width: 150px;">Ward Initial</th>
                                            <th>Ward Name</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($wards as $ward)
                                            <tr>
                                                ...
                                                <td>{{ Str::upper($ward->initial) }}</td>
                                                <td>
                                                    <strong> {{ $ward->name }} </strong>
                                                </td>
                                                <td>
                                                    <button class="edit-element btn btn-primary px-2 py-1" title="Edit ward" data-id="{{ $ward->id }}"><i data-feather="edit"></i></button>
                                                    <button class="btn btn-dark rem-element px-2 py-1" title="Delete ward" data-id="{{ $ward->id }}"><i data-feather="trash-2"></i> </button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error)
                {
                    ...
                    $("#editForm input[name='edit_name']").val(data.ward.name);
                }
                else
                {
                    alert(data.error);
