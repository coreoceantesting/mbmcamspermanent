<x-admin.admin-layout>
    <x-slot name="title">{{ auth()->user()->tenant_name }} - Designations</x-slot>
                        ...
                        <form class="form-horizontal form-bordered" method="post" id="editForm">
                            ...
                            <section class="card">
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-md-4">
                                            <label class="col-form-label" for="edit_name">Designation Name <span class="text-danger">*</span></label>
                                            <input class="form-control" id="edit_name" name="edit_name" type="text" placeholder="Designation Name">
                            ...
                            <div class="table-responsive">
                                <table class="table-bordered" id="datatable-tabletools">
                                    <thead>
                                        <tr>
                                            <th>Sr No</th>
                                            <th style="max-width: 150px;">Designation Initial</th>
                                    ...
                                    <tbody>
                                        @foreach ($designations as $designation)
                                            <tr>
                                                ...
                                                <td>{{ Str::upper($designation->initial) }}</td>
                                                <td>
                                                    <strong> {{ $designation->name }} </strong>
                                                </td>
                                                <td>
                                                    @can('designations.edit')
                                                        <button class="edit-element btn btn-primary px-2 py-1" title="Edit designation" data-id="{{ $designation->id }}"><i data-feather="edit"></i></button>
                                                    @endcan
                                                    @can('designations.delete')
                                                        <button class="btn btn-dark rem-element px-2 py-1" title="Delete designation" data-id="{{ $designation->id }}"><i data-feather="trash-2"></i> </button>
                                                    @endcan
                                                </td>
                                            </tr>
                                        @endforeach
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error)
                {
                    ...
                    $("#editForm input[name='edit_name']").val(data.designation.name);
                }
                else
                {
                    alert(data.error);
