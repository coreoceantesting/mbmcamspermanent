<x-admin.admin-layout>
    <x-slot name="title">{{ auth()->user()->tenant_name }} - Shift Wise Employee</x-slot>
            ...
            <div class="page-header">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <form class="theme-form" method="GET" action="{{ route('dashboard.shift-wise-employee') }}">
                                @csrf
                                    ...
                                    <tbody>
                                        @forelse ($data as $value)
                                            <tr>
                                                ...
                                                <td>{{ Carbon\Carbon::parse($value->shift?->from_time)->format('h:i A') }}</td>
                                            </tr>
                                        @empty
                                            <tr>
                                                <td></td>
