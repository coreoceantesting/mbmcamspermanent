<x-admin.admin-layout>
    <x-slot name="title">{{ auth()->user()->tenant_name }} - {{ ucwords(str_replace('_', ' ', $pageType)) }} Medical Leave</x-slot>
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-header">
                        ...
                        <div class="card">
                            <form class="theme-form" name="addForm" id="addForm">
                                ...
                                <div class="card-header pb-0">
                                    <h4>Create {{ ucwords(str_replace('_', ' ', $pageType)) }} Medical Leave</h4>
                                </div>
                        ...
                        <form class="form-horizontal form-bordered" method="post" id="editForm">
                            ...
                            <section class="card">
                                <header class="card-header pb-0">
                                    <h4 class="card-title">Edit {{ ucwords(str_replace('_', ' ', $pageType)) }} Medical Leave</h4>
                                </header>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3>{{ ucwords(str_replace('_', ' ', $pageType)) }} Medical Leave</h3>
                    </div>
                    <div class="col-sm-6">
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        @foreach ($leaveRequests as $request)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ asset($request->document->path) }}" target="_blank" class="btn btn-primary" >View</a>
                                                </td>
                                                <td>
                                                    @if ($isAdmin)
