                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <input class="form-control" id="work_duration" name="work_duration" type="number" min="1" max="12" placeholder="Enter Work " step="any">
                                            <span class="text-danger error-text work_duration_err"></span>
                                        </div>

                                        <div class="col-md-4 mt-3">
                                            <label class="col-form-label" for="sa_duration">Saturday Work  </label>
                                            <input class="form-control" id="sa_duration" name="sa_duration" type="number" min="1" max="12" placeholder="Enter Saturday Work " step="any">
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error) {
                    ...
                    // Toggle benefit-upload visibility
                    ...
                    if (data.user.fixation_document) {
                        $('#fixation_document_existing').val(data.user.fixation_document);
                        $("#fixation_document_view").html(`
                            <div class="mt-2">
                                <a href="storage/${data.user.fixation_document}" target="_blank">
                                    View
                                </a>
                            </div>
                        `);
