                        ...
                        <div class="card">
                            <form class="theme-form" name="addForm" id="addForm">
                                ...
                                <div class="card-header pb-0">
                                    <h4>Create {{ ucwords(str_replace('_', ' ', $pageType)) }} {{ $pageType == 'outpost' ? '' : 'Leave' }}</h4>
                                </div>
                        ...
                        <form class="form-horizontal form-bordered" method="post" id="editForm">
                            ...
                            <section class="card">
                                <header class="card-header pb-0">
                                    <h4 class="card-title">Edit {{ ucwords(str_replace('_', ' ', $pageType)) }} {{ $pageType == 'outpost' ? '' : 'Leave' }}</h4>
                                </header>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($request->leaveType->name == 'EL' && $request->is_approved == 1)
                                                     <a href="{{ route('leave-requests.generate_pdf', $request->id) }}" class="ml-1   btn btn-primary px-2 py-1" title="Generate Pdf"  data-id="{{ $request->id }}" target="_blank">Generate Pdf</a>
                                                    @endif
