...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/fixedcolumns/4.0.1/css/fixedColumns.bootstrap4.min.css" />
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 footer-copyright">
                            <p class="mb-0">Copyright {{ \Carbon\Carbon::now()->subYear()->format('y')."-".\Carbon\Carbon::now()->format('y') }} © Core Ocean All rights reserved.</p>
                        </div>
                        <div class="col-md-6">
